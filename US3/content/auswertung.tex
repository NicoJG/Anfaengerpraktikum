...
\begin{table}
    ...
    \begin{tabular}{S[table-format=1.1] S[table-format=1.2] S[table-format=1.2] S[table-format=1.2] S[table-format=1.2]}
        \toprule
        \tableSI{\dot{v}}{\frac{\liter}{\minute}} & \tableSI{\dot{v}}{\frac{\meter}{\second}} & \tableSI{v_{15}}{\frac{\meter}{\second}} &\tableSI{v_{30}}{\frac{\meter}{\second}} & \tableSI{v_{60}}{\frac{\meter}{\second}}\\
        \midrule
