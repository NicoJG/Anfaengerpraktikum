...
\begin{table}
    ...
    \begin{tabular}{S[table-format=1.1] S[table-format=1.2] S[table-format=1.2] S[table-format=1.2] S[table-format=1.2]}
        \toprule
        \tableSI{\dot{v}}{\liter\per\minute} & \tableSI{\dot{v}}{\meter\per\second} & \tableSI{v_{15}}{\meter\per\second} &\tableSI{v_{30}}{\meter\per\second} & \tableSI{v_{60}}{\meter\per\second}\\
        \midrule
...
Anschließend werden drei Plots für die verschiedenen Dopplerwinkel erstellt.
\begin{figure}
    \centering
...
\begin{table}
    ...
    \begin{tabular}{S[table-format=2.2] S[table-format=3.0] S[table-format=3.0] S[table-format=1.2] S[table-format=3.0] S[table-format=3.0] S[table-format=1.2] }
        \toprule
        \tableSI{s}{\milli\meter} & \tableSI{\nu _1}{\hertz} & \tableSI{I_1}{\frac{100\volt\squared}{\second}} & \tableSI{v_1}{\meter\per\second} & \tableSI{\nu_2}{\hertz} & \tableSI{I_2}{\frac{100\volt\squared}{\second}} & \tableSI{v_2}{\meter\per\second}\\
        \midrule
