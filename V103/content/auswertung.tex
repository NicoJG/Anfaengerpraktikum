...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{build/plot_zweiseitig_eckig_rechts.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{build/plot_zweiseitig_rund_links.pdf}
    \caption{Graph der Werte links von $\frac{L}{2}$.}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{build/plot_zweiseitig_rund_rechts.pdf}
    \caption{Graph der Werte rechts von $\frac{L}{2}$.}
