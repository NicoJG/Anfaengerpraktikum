...
Mit den Formeln \autoref{eq:mittel} und \autoref{eq:mittelab} wird erneut ein Wert für $R$ gemittelt und die Abweichung bestimmt. Für $R$ ergibt sich dann
\begin{equation}
...
Durch den Curve Fit ergibt sich der Plot \autoref{}

\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{build/plot_zweiseitig_eckig_links.pdf}
...
Die Werte werden aus \autoref{tab:werte_eckig_beidseitig} entnommen.
Aus \autoref{tab:beidseitig_eckig} werden alle Auslenkungen $x > \frac{L}{2}$ verwendet.
Der Curve Fit gibt wieder die beiden Parameter $a$ und $b$ aus.
...
Mittelwert und Abweichung von $E$ betragen $E = $
