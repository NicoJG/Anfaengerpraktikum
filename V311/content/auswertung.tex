...
\begin{table}
    ...
    \begin{tabular}{S[table-format=1.1] S[table-format=4.0] S[table-format=3.0] S[table-format=4.2] S[table-format=-2.2]}
        \toprule
        \tableSI{I_B}{\ampere} & \tableSI{B_1}{\milli\tesla} & \tableSI{B_2}{\milli\tesla} & \multicolumn{2}{c}{\tableSI{B}{\milli\tesla}} \\
        \midrule
        0.5 & 145 & 150 & 66 & +-30 \\
        1.0 & 287 & 290 & 312 & +-32 \\
        1.5 & 426 & 431 & 435 & +-34 \\
...
\begin{table}
    ...
    \begin{tabular}{S[table-format=1.1] S[table-format=4.2] S[table-format=-2.2] S[table-format=-1.3]}
        \toprule
        \tableSI{I_B}{\ampere} & \multicolumn{2}{c}{\tableSI{B}{\milli\tesla}} & \tableSI{U_\text{H}}{\milli\volt} \\
        \midrule
        0.0 & 66 & +-30 & -0.009\\
        0.5 & 189 & +-31 & -0.007\\
        1.0 & 312 & +-32 & -0.005\\
