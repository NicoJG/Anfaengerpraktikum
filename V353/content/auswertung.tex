...
\begin{table}
    ...
    \begin{tabular}{S[table-format=4.0] S[table-format=1.3] S[table-format=1.3] S[table-format=1.3] S[table-format=1.3]}
        \toprule
        \tableSI{f}{\hertz} & \tableSI{U_C}{\volt} & \tableSI{a_{\text{gemessen}}}{\milli\second} & \tableSI{a}{\milli\second} & \tableSI{\varphi}{\radian} \\
        \midrule
        20 & 1.000 & 25.000 & 0.000 & 0.000 \\
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth-1cm]{build/plot_spannungen.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth-1cm]{build/plot_phasen.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=7cm]{build/plot_polar.pdf}
